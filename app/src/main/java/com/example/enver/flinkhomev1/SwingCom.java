...
public class SwingCom extends AppCompatActivity {

    ArrayList<String> dataSwing = new ArrayList<>();
    ListView commandsSwing;
    LayoutInflater layoutInflater;
    RelativeLayout activity;
    String espResponse="no";
    SwingCom.CountDownTimer brojac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swing_com);
        bundle = getIntent().getExtras();
        devName = bundle.getString("devicename");
        if(isOnline()) {
            activity = (RelativeLayout) findViewById(R.id.swingCom_activity);
            commandsSwing = (ListView) findViewById(R.id.commandsSwing);
            commandsSwing.setDivider(null);
            ...
            dataSwing.add("14");
            dataSwing.add("15");
            commandsSwing.setAdapter(new SwingCom.MyGridAdapter(this, R.layout.list_item_command, dataSwing));
            ...
            Integer intager=0;
            getData("http://159.203.107.114/flinkphp/commandget.php?Username=" + usern +"&Devicename="+ deviceNameurl +"&Roomname=" + roomNameurl + "&Commandname=ComS");
    ...
    private class MyGridAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            SwingCom.ViewHolder mainViewHolder = null;
            if(AREJ[position].equals("1"))  layout = R.layout.list_item_command_added;
            if(convertView == null){
                if(getItem(position).equals("11"))
                    title = "SWING 1";
                else if(getItem(position).equals("12"))
                    title = "SWING 2";
                else if(getItem(position).equals("13"))
                    title = "SWING 3";
                else if(getItem(position).equals("14"))
                    title = "SWING 4";
                else if(getItem(position).equals("15"))
                    title = "SWING 5";
                LayoutInflater inflater = LayoutInflater.from(getContext());
                convertView = inflater.inflate(layout, parent, false);
                SwingCom.ViewHolder viewHolder = new SwingCom.ViewHolder();
                    ...
                    public void onClick(View view) {
                                                        ...
                                                        public void onSuccess(IMqttToken asyncActionToken) {
                                                            ...
                                                            MqttCallback mqttCallback = new MqttCallback() {
                                                                ...
                                                                public void messageArrived(String topic, MqttMessage message) throws Exception {
                                                                   ...
                                                                   // commandStatus(textCommandPopup,getResources().getString(R.string.press_ok_button),fadePopup,CommandPopup);
                                                                    client.disconnect();
                                                                }
                                        ...
                                        public void onSuccess(IMqttToken asyncActionToken) {
                                            ...
                                            try {
                                                ...
                                                clientpublish.setActionCallback(new IMqttActionListener() {
                                                    ...
                                                    public void onSuccess(IMqttToken asyncActionToken) {
                                                        String a ="";
                                                        if(getItem(position).equals("11")) a = "ComSwing1";
                                                        else if(getItem(position).equals("12")) a = "ComSwing2";
                                                        else  if(getItem(position).equals("13")) a = "ComSwing3";
                                                        else if(getItem(position).equals("14")) a = "ComSwing4";
                                                        else if(getItem(position).equals("15")) a = "ComSwing5";
                        ...
                        Komanda.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                String a ="";
                                if(getItem(position).equals("1")) a = "ComSwing1";
                                else if(getItem(position).equals("2")) a = "ComSwing2";
                                else  if(getItem(position).equals("3")) a = "ComSwing3";
                                else if(getItem(position).equals("4")) a = "ComSwing4";
                                else if(getItem(position).equals("5")) a = "ComSwing5";
                        ...
                        */
                        ...
                        container.setOnTouchListener(new View.OnTouchListener() {
                            ...
                            public boolean onTouch(View view, MotionEvent motionEvent) {
                                ...
                                final Toast toast = Toast.makeText(SwingCom.this, text, Toast.LENGTH_SHORT);
                ...
                mainViewHolder = (SwingCom.ViewHolder) convertView.getTag();
    ...
    public void commandStatus(TextView textView,String string, final PopupWindow popupWindow1, final PopupWindow popupWindow2){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent refreshIntent=new Intent(SwingCom.this,SwingCom.class);
    ...
    public abstract class CountDownTimer {
         ...
         * Start the countdown.
         */
        public synchronized final SwingCom.CountDownTimer start() {
        ...
        private Handler mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                synchronized(SwingCom.CountDownTimer.this) {
    ...
    public void notOnline(){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                final View mDrawerLayout = (RelativeLayout) findViewById(R.id.swingCom_activity);
