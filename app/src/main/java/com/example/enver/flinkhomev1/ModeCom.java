...
public class ModeCom extends AppCompatActivity {

    ArrayList<String> dataMode = new ArrayList<>();
    ListView commandsMode;
    LayoutInflater layoutInflater;
    RelativeLayout activity;
    String espResponse="no";
    String title ="";
    ModeCom.CountDownTimer brojac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mode_com);
        bundle = getIntent().getExtras();
        devName = bundle.getString("devicename");

        if(isOnline()) {
            activity = (RelativeLayout) findViewById(R.id.modeCom_activity);
            commandsMode = (ListView) findViewById(R.id.commandsMode);
            commandsMode.setDivider(null);
            ...
            dataMode.add("5");
            dataMode.add("6");
            commandsMode.setAdapter(new ModeCom.MyGridAdapter(this, R.layout.list_item_command, dataMode));
            ...
            Integer intager=0;
            getData("http://159.203.107.114/flinkphp/commandget.php?Username=" + usern +"&Devicename="+ deviceNameurl +"&Roomname=" + roomNameurl + "&Commandname=ComM");
    ...
    private class MyGridAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ModeCom.ViewHolder mainViewHolder = null;
            if(AREJ[position].equals("1"))  layout = R.layout.list_item_command_added;
            if(convertView == null){
                if(getItem(position).equals("2"))
                    title = "AUTO";
                else if(getItem(position).equals("3"))
                    title = "FAN";
                else if(getItem(position).equals("4"))
                    title = "COOL";
                else if(getItem(position).equals("5"))
                    title = "DRY";
                else if(getItem(position).equals("6"))
                    title = "HEAT";
                LayoutInflater inflater = LayoutInflater.from(getContext());
                convertView = inflater.inflate(layout, parent, false);
                ModeCom.ViewHolder viewHolder = new ModeCom.ViewHolder();
                    ...
                    public void onClick(View view) {
                                        ...
                                        public void onSuccess(IMqttToken asyncActionToken) {
                                            ...
                                            try {
                                                ...
                                                clientpublish.setActionCallback(new IMqttActionListener() {
                                                    ...
                                                    public void onSuccess(IMqttToken asyncActionToken) {
                                                        String a ="";
                                                        if(getItem(position).equals("2")) a = "ComAuto";
                                                        else  if(getItem(position).equals("3")) a = "ComCool";
                                                        else if(getItem(position).equals("4")) a = "ComDry";
                                                        else if(getItem(position).equals("5")) a = "ComFan";
                                                        else  if(getItem(position).equals("6")) a = "ComHeat";
                        ...
                        Komanda.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                String a ="";
                                if(getItem(position).equals("Auto")) a = "ComAuto";
                                else  if(getItem(position).equals("Cool")) a = "ComCool";
                                else if(getItem(position).equals("Dry")) a = "ComDry";
                                else if(getItem(position).equals("Fan")) a = "ComFan";
                                else  if(getItem(position).equals("Heat")) a = "ComHeat";
                                BackgroundWorker backgroundWorker = new BackgroundWorker(getApplicationContext());
                                backgroundWorker.execute("commandcommit",usern,devName,roomName,a);
                        ...
                        */
                        container.setOnTouchListener(new View.OnTouchListener() {
                            ...
                            public boolean onTouch(View view, MotionEvent motionEvent) {
                                ...
                                final Toast toast = Toast.makeText(ModeCom.this, text, Toast.LENGTH_SHORT);
                ...
                mainViewHolder = (ModeCom.ViewHolder) convertView.getTag();
    ...
    public void commandStatus(TextView textView,String string, final PopupWindow popupWindow1, final PopupWindow popupWindow2){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent refreshIntent=new Intent(ModeCom.this,ModeCom.class);
    ...
    public abstract class CountDownTimer {
         ...
         * Start the countdown.
         */
        public synchronized final ModeCom.CountDownTimer start() {
        ...
        private Handler mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                synchronized(ModeCom.CountDownTimer.this) {
    ...
    public void notOnline(){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                final View mDrawerLayout = (RelativeLayout) findViewById(R.id.modeCom_activity);
